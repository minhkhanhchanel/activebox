...
function showMenuMobile() {
    mobileModal.classList.toggle('open'),mobileIconModal.classList.toggle('fa-times')
}
// function hideMenuMobile() {
//     mobileModal.classList.toggle('open'), mobileIconModal.classList.remove('fa-times')
// }
